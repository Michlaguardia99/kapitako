...
<body style="background-size:cover ;background-repeat: no-repeat;background-image: url('./images/Background.jpg'); background-position:fixed">
<div class="container">
    <div class="row mb-0">
                ...
                <div class="card p-3 border-3 shadow-sm">
                    <div class="card-body">
                        <form method="post" action="{{ url('/login') }}">
                            @csrf
                            <div>
                            <h1><p class="text-light">Login<p><h1></p></div>
